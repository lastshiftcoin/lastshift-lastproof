...
Read `/Users/the operator2023/.claude/projects/-Users-the operator2023-Documents-Claude-Projects-LASTSHIFT/memory/MEMORY.md` and all linked memory files at session start. Key rules:
