...
Grid wireframe earlier. **Per the operator's decision on the Grid:** avatars
...
- Per the operator: **no CTA button on empty state** ("copy my profile link"
...
- **Random-shuffle for chad ordering** — per the operator "intentionally
