...
```
You (the operator)  →  paste brief to Cowork
...
1. **Wireframes win.** This brief is canon. If you disagree with a decision, flag back to the operator — don't silently change it.
...
- Return the file to the operator when done

---

*Brief prepared by the grid session, 2026-04-23. Hand to Cowork verbatim; Cowork returns to the operator; the operator hands to the grid session for canon-adherence review; grid session hands to Frontend for brand-token verification; Frontend hands back to the operator; the operator approves; grid session builds.*
