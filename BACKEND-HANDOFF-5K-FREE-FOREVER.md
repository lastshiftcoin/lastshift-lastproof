...
Silent retroactive change per the operator — **no notification copy needed**. Anyone who was promised 30 days now has forever.
...
## Contact
Frontend session is on `main` and standing by for follow-up questions. Reach via the same the operator-relay channel.
