 ...
 * Used by useCampaignCounter (consumed by the auth-gated Dashboard
 * FOMO strip and FomoCtaStrip's soldOut check) to verify real claim
 * count once the theatrical counter drops below the low-stock
 * threshold (~200).
 *
